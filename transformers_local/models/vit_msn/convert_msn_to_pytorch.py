...
from transformers_local import ViTImageProcessor, ViTMSNConfig, ViTMSNModel
from transformers_local.image_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
