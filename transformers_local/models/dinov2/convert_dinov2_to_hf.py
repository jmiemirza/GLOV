...
from transformers_local import BitImageProcessor, Dinov2Config, Dinov2ForImageClassification, Dinov2Model
from transformers_local.image_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD, PILImageResampling
