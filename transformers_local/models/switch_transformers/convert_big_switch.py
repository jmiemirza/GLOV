...
from transformers_local.modeling_utils import dtype_byte_size
from transformers_local.models.switch_transformers.convert_switch_transformers_original_flax_checkpoint_to_pytorch import (
    rename_keys,
)
from transformers_local.utils import WEIGHTS_INDEX_NAME, WEIGHTS_NAME
from transformers_local.utils.hub import convert_file_size_to_int
...
def sanity_check():
    from transformers_local import SwitchTransformersConfig, SwitchTransformersForConditionalGeneration, T5Tokenizer
