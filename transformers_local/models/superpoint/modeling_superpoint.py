...
from transformers_local import PreTrainedModel
from transformers_local.modeling_outputs import (
    BaseModelOutputWithNoAttention,
)
from transformers_local.models.superpoint.configuration_superpoint import SuperPointConfig
