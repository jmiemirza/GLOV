...
from transformers_local import AutoImageProcessor, VanConfig, VanForImageClassification
from transformers_local.models.deprecated.van.modeling_van import VanLayerScaling
