...
from transformers_local.models.whisper.tokenization_whisper import LANGUAGES, bytes_to_unicode
from transformers_local.utils.import_utils import _is_package_available
