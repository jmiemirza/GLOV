...
def import_protobuf(error_message=""):
    if is_protobuf_available():
        ...
        if version.parse(google.protobuf.__version__) < version.parse("4.0.0"):
            from transformers_local.utils import sentencepiece_model_pb2
        else:
            from transformers_local.utils import sentencepiece_model_pb2_new as sentencepiece_model_pb2
